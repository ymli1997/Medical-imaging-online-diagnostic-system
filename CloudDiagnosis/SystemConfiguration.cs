...
namespace CloudDiagnosis
{
    public class SystemConfiguration
    {
        ...
        /// 主程序界面实例
        /// </summary>
        public static CloudDiagnosis.FormMain FormMain = null;
        public static CloudDiagnosis.Entity.UserInfo LoginUser = null;
        public static CloudDiagnosis.Entity.Reports report = null;


        public class UIFormName
        {
            public static string FormSiteMap = "CloudDiagnosis.UI.Tabs.FormSiteMap";
            public static string FormSiteMapImage = "CloudDiagnosis.UI.Tabs.FormSiteMapImage";
            public static string FormVelocity = "CloudDiagnosis.UI.Tabs.FormVelocity";
            public static string FormVector = "CloudDiagnosis.UI.Tabs.FormVector";
            public static string FormLongitudinalDisplacement = "ClouCloudDiagnosis.UI.Tabs.FormLongitudinalDisplacement";
            public static string FormTransverseDisplacement = "CloudDiagnosis.UI.Tabs.FormTransverseDisplacement";
            public static string FormHeightDisplacement = "CloudDiagnosis.UI.Tabs.FormHeightDisplacement";
            public static string FormMultipleGraphs = "CloudDiagnosis.UI.Tabs.FormMultipleGraphs";
            public static string FormReports = "CloudDiagnosis.UI.Tabs.FormReports";
        }
