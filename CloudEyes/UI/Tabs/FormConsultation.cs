                ...
                try
                {
                    ...
                    //发送图片
                        ...
                        if (pb.Image != null)
                        {
                            ...
                            pb.Image.Save("7.jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
                            pb.Image.Dispose();

                            pb.Dispose();
                            Clipboard.Clear();
                            byte[] buffer = getBytes("7.jpg");//转为二进制
                            ...
                            cs.ReceiverID = Convert.ToDecimal(report.AuditUserID);
...
/// <returns></returns>
        ...
        public override void FormOnLoad()
        {
            ...
            if (report.Report_ID != 0)
            {
               ...
               //} 
                ...
                cs.SenderID = Convert.ToDecimal(report.AuditUserID);
                cs.Report_ID = report.Report_ID;
        ...
        private void ReadRichTextBox_MouseEnter(object sender, EventArgs e)
        {
            ...
            //this.ReadRichTextBox.BackColor = Color.Red;
