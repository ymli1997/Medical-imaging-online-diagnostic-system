...
using static CloudEyes.FormMain;
using System.IO;
    ...
    public void MergeCells(Microsoft.Office.Interop.Excel.Worksheet workSheet, int beginRowIndex, int beginColumnIndex, int endRowIndex, int endColumnIndex, string text)
    {
        ...
        public override void FormOnLoad()
        {
            ...
            if (report != null)
            {
                ...
                //{
                //    textBoxLocationSeg.Text = report.StudyLocalDirectory.Replace(".nii.gz", "_seg1.nii.gz");   //替换的方法
                //}
        ...
        private void buttonOpenDirectory_Click_2(object sender, EventArgs e)
        {
        ...
        private void textBoxEvaluateInformation_TextChanged(object sender, EventArgs e)
        {
