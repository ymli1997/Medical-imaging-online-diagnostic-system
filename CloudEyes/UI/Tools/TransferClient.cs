...
namespace file_transfer
{
    ...
    public class TransferClient
    {
        ...
        private byte[] _buffer = new byte[4113];
        ...
        {
            _baseSocket = new Socket(AddressFamily.InterNetworkV6, SocketType.Stream, ProtocolType.Tcp);
        }
...
#pragma warning restore CS0436 // 类型与导入类型冲突
            ...
            {
                MessageBox.Show("文件"+fileName+"传输失败"+'\n'+e, "提示", MessageBoxButtons.YesNo);
            }
        }
