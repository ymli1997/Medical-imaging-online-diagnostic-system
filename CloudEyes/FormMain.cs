...
using CloudEyes.UI.Tools;
using CloudEyes.UI.Help;
using CloudEyes.UI.File;
using CloudEyes.UI.Configuration;
...
namespace CloudEyes
{
    public partial class FormMain : Form
    {
        ...
        {
            AddANewTab("CloudEyes.UI.Tabs.FormReportQuery");
        ...
        private void SetLabelStatusSelectedPoints()
        {
            ...
            //selectedPointsList = PointsHelper.GetPointsListFromPoinMs(SelectedReport);
            //selectedPointsList = string.Format("已经选择{0}个监测点：{1}", SelectedReport.Length, selectedPointsList);
        ...
        /// 所有监测点
        /// </summary>
        private CloudEyes.Entity.Reports[] _reports = null;

        /// <summary>
        /// 所有监测点
        /// </summary>
        public CloudEyes.Entity.Reports[] AllReports
        {
            get
            {
                return _reports;
        ...
        private void GetAllReport()
        {
            ...
            string jsonResult = serviceClient.GetReportsByUserID(SystemConfiguration.LoginUser.User_ID);
            //把集合放入json中
            //反序列化对象  
        ...
        /// 选中的监测点
        /// </summary>
        public CloudEyes.Entity.Reports SelectedReport
        {
            get
            {
        ...
        private void menuItemDicomImport_Click(object sender, EventArgs e)
        {
            ...
            if (formDicomUpload.DialogResult == DialogResult.OK)
            {
                InitTree();
            }
        }
        ...
        {
            string formName = getForm(SystemConfiguration.UIFormName.FormReportQuery).Text;
        ...
        {
            //FormTabBase formTabBase = tabControlMain.SelectedPanel.Controls[0] as FormTabBase;
            //if (formTabBase.Changed)
            //{
            //    if (DialogResult.Cancel == MessageBox.Show("发现数据有变化，是否退出？退出可能造成数据丢失。", "注意", MessageBoxButtons.YesNoCancel))
            //    {
            //        e.Cancel = true;
        ...
        private void buttonQuery_Click(object sender, EventArgs e)
        {
            ...
            //    foreach (Reports report in _reports)
            //    {
            //        if ((textBoxQuery.Text == report.PatientName) || (report.IsAudited == false && textBoxQuery.Text == "未审核") || (report.IsAudited == true && textBoxQuery.Text == "已审核"))
            //        {
            //            advTreePoints.Nodes.Clear();
            //            AddReportNode(report);
            //        }
