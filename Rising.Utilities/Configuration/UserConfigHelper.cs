...
namespace Rising.Utilities
{
    ...
    public class UserConfigHelper
    {
        ...
        public static void GetConfig(string fileName)
        {
            ...
            // 密码强度检查
            if (Exists("CheckPasswordStrength"))
            {
                BaseSystemInfo.CheckPasswordStrength = (String.Compare(GetValue(xmlDocument, "CheckPasswordStrength"), "TRUE", true, CultureInfo.CurrentCulture) == 0);
            }
            if (Exists("RecordLog"))
            {
            ...
            {
                BaseSystemInfo.UserCenterDbType = BaseConfiguration.GetDataBaseType(GetValue(xmlDocument, "UserCenterDbType"));
            }
            if (Exists("BusinessDbType"))
            {
                BaseSystemInfo.BusinessDbType = BaseConfiguration.GetDataBaseType(GetValue(xmlDocument, "BusinessDbType"));
            }
            if (Exists("WorkFlowDbType"))
            {
                BaseSystemInfo.WorkFlowDbType = BaseConfiguration.GetDataBaseType(GetValue(xmlDocument, "WorkFlowDbType"));
            }
        ...
        public static void SaveConfig(string fileName)
        {
            ...
            // 密码强度检查
            SetValue(xmlDocument, "CheckPasswordStrength", BaseSystemInfo.CheckPasswordStrength.ToString());
            ...
            SetValue(xmlDocument, "DataBaseType", BaseSystemInfo.BusinessDbType.ToString());
