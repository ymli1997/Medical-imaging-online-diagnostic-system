...
namespace Rising.Utilities
{
    ...
    public class RegistryHelper
    {
        ...
        /// 注册表中的位置
        /// </summary>
        public static string SubKey = "Software\\" + "Rising TECH";
        ...
        {
            SubKey = "Software\\" + "Rising TECH" + "\\" + BaseSystemInfo.SoftName;
            // 客户信息配置
            ...
            BaseSystemInfo.BusinessDbType = BaseConfiguration.GetDataBaseType(GetValue("DataBaseType"));
        ...
        private static void SetValues()
        {
            ...
            SetValue("RegisterKey", "Rising TECH");
        }
        #endregion
        ...
        public static void GetConfig()
        {
            ...
            if (!Exists("Software", "Rising TECH"))
            {
                // 设置注册表
                SetValues();
            }
